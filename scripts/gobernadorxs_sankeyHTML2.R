...
#Colores
################################
ColourScal ='d3.scaleOrdinal() .range(["#ADB5BD", "#FFBF69", "#6A040F", "#1D3557", "#E9C46A", "#E63946", "#DEE2FF", "#A8DADC"])'
...
#Gráfica
################################
p <- sankeyNetwork(Links = guber_alluvial2_s, Nodes = nodes2,
...
# save the widget
library(htmlwidgets)
saveWidget(p, file=paste0( getwd(), "/www/html/sankey_2019-2022.html"))
